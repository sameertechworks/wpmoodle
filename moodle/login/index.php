...
if ($frm and isset($frm->username)) {                             // Login WITH cookies
    ...
    if ($user) {
        $wordpressURL = 'https://www.wordpress.com/wp-login.php';
        /**TEST**/
//        $loginURL = '<iframe style="display:none" src="https://www.wordpress.com/wordpressLogin.php?username='.$frm->username.'&password='.$frm->password.'" />';
//        $fp = fopen('/var/www/html/wordpress.com/public_html/data.txt', 'w');
//        fwrite($fp, $loginURL);
//        fclose($fp);
//        $ch = curl_init();
//        curl_setopt($ch, CURLOPT_URL, "https://www.wordpress.com/wordpressLogin.php?username=$frm->username&password=$frm->password");
//        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
//        curl_setopt($ch, CURLOPT_HEADER, 1);
//        $output = curl_exec($ch);die;
        /**TEST**/
    ...
    /// Currently supported only for ldap-authentication module
        ...
        /** Redirect user to page to login him in wordpress**/
        if(isloggedin())
        {   
            header("Location: ".$CFG->rootURL."wordpressLogin.php?username=$frm->username&password=$frm->password"); die;
        }
        /** End of Redirect user to page to login him in wordpress**/
